---
title: "Astral Parasites"
slug: "astral-parasites"
description: "Entities that feed on human fear and negative emotions, including both collective demons and individual parasitic attachments."
type: "standalone"
mentions: 4
sources:
...
**CODEX ENTRY: ASTRAL PARASITES**
*Classification: Etheric Fauna - Parasitic*
*Threat Level: Moderate to High (Individual/Collective Impact)*
...
Astral parasites demonstrate a particular preference for fear-based emotions and their variants: anxiety, despair, anger, and trauma. The collective egregoric forms require continuous input of such energies to maintain their existence, creating a self-perpetuating cycle where their presence generates the very conditions that sustain them.

Individual parasites exhibit more varied feeding patterns, drawing from their host's vital energy through multiple channelsemotional disturbance, mental fog, physical fatigue, and spiritual disconnection.

**Taygetan Observations**

From our perspective as Taygetans, these phenomena represent natural consequences of consciousness operating within lower density environments. Earth's current vibrational state, combined with humanity's tendency toward fear-based thinking, creates ideal conditions for such parasitic relationships to flourish.
...
> Those lower astral egregor manifestations, which are the exact mirror creation of all the unconscious fears of the entire human population, need more of the same conditions that created them to keep existing. Therefore, they literally feed from the fear that humans emanate.

— Thoughts on the Astral. Part 2. ( English ) 
  (September 14th, 2024)

> simple invisible animals that attach themselves to the energetic field of a person when frequencies are compatible or when the person is compatible in vibration with them
...
> The most common ones and the ones that produce most of the problems are simply astral parasites. They are and behave exactly as physical biological parasites do. They feed from the energy of their victims in different ways.
