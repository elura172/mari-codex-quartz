...
description: "The concept that time travel and decisions create alternative timelines without changing the original timeline."
type: "standalone"
mentions: 2
sources:
...
**CODEX ENTRY: TIMELINE MANIFESTATION THROUGH CONSCIOUSNESS**

*Stardate Classification: Temporal Mechanics - Advanced Theory*
*Source Authority: Swaruu of Erra Transmissions*
*Compiled for: Diplomatic Corps & Navigation Crews*
...
**The Impossibility of Paradox**

Mari Swaruu illuminated a profound truth that liberates temporal explorers from the fear of causality violations: authentic paradoxes cannot manifest within a consciousness-responsive universe. Time, as experienced by aware beings, exists in a state of infinite malleability rather than rigid predetermination. Each potential variation flowers into its own complete timeline, creating a vast garden of parallel existences rather than a collision of contradictory realities.
...
> Going back in time to change events cannot alter the timeline from which the traveler came from and from where the decision to change those specific unwanted events came from as well, simply because the line of events or timeline still exists in the awareness and in the memory of the traveler himself

— Is it really necessary to change your past? ( SV-55 English)     

> Whenever you jump in time, you create an alternate reality, or an alternate timeline, simply because you observed it while being conscious that you are time-traveling.

— Basic Principles for Real Time Travel, Third Part. Starships. ( English )     

> This also means that no paradoxes can ever happen, as time as a perception is never fixed and contains an infinite number of variants and possibilities for each timeline.
